...
6. **Стандартные алиасы** для clojure.* библиотек — использовать общепринятые сокращения:
   ```clojure
...
11. **Поддерживать документацию в актуальном состоянии** — если изменение кода меняет структуру проекта, конфигурацию, команды, поведение или архитектурные допущения, в том же изменении обновлять `README.md` и соответствующие файлы в `docs/`.
